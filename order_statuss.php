...
// Fetch order details from cognitive_corner_orders
$stmt = $conn->prepare("SELECT id, order_number, order_status, total_price FROM cognitive_corner_orders WHERE id = ?");
...
// Fetch order items from cognitive_corner_order_items
